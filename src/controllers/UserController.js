...
exports.register = async (req, res) => {
  ...
  console.log("SE SACAN LOS DATOS");
  const errors = [];
  try {
    //Validaciones
    if (name === "" || lastname === "") {
    ...
    console.log(
      "SE TERMINA DE VALIDAR LOS DATOS. SE VERIFICA SI EXISTE EL USUARIO"
    );
    ...
    console.log("EXISTE EL USUARIO. SE EMPIEZA A VALIDAR AL USUARIO");
    ...
    console.log("SE INTENTA CREAR EL USUARIO");
    //Crear usuario
